...
bool Lista_Torneos::cons_torneo_iniciado(string &t) {
  return ltorn[t].cons_esta_iniciado();
}

bool Lista_Torneos::cons_torneo_hay_historial(string &t) {
  return ltorn[t].hay_historial();
}
...
void Lista_Torneos::puntos_torneo(string &t) {
  ltorn[t].imprimir_puntos();
}